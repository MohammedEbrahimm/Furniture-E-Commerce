    ...
    override fun onBindViewHolder(holder: AddressViewHolder, position: Int) {
        ...
        holder.binding.buttonAddress.setOnClickListener {
            if (selectedAddress >= 0)
                notifyItemChanged(selectedAddress) // this will make sure to unselect the current address
            selectedAddress = holder.adapterPosition
            notifyItemChanged(selectedAddress) // this will make sure to select the button and to change its color
