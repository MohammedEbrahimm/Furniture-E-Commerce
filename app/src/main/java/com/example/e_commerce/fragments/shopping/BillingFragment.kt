...
class BillingFragment : Fragment() {
    ...
    private val args = navArgs<BillingFragmentArgs>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        products = args.value.products.toList()
        totalPrice = args.value.totalPrice
    ...
    private fun collectUserAddress() {
