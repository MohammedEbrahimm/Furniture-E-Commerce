...
class OrderViewModel @Inject constructor(
    ...
    fun placeOrder(order: Order){
        ...
        firestore.runBatch { batch ->
            ...
            // we cant actually delete an entire collection in firestore this is not available and for that we need to delete each document inside that collection so we will have a loop on our documents and delete each document
